<div>
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <flux:heading size="xl">Create Quiz</flux:heading>
            <flux:subheading>Build a quiz from published questions in the question bank.</flux:subheading>
        </div>
    </div>
                    ...
                    @empty
                        <div class="py-10 text-center text-sm text-zinc-500 dark:text-zinc-400">
                            ...
                            @else
                                ...
                                <a href="{{ route('admin.questions.index') }}" class="underline ml-1" wire:navigate>Go to Question Bank</a>
                            @endif
                        </div>
                    @endforelse
                </div>
